...
#define DOC_SURFACE_GETPIXELFORMAT "get_pixel_format(format) -> PixelFormat\nget_pixel_format(masks, depth) -> PixelFormat\nGet a PixelFormat instance describing the pixel format for a Surface"

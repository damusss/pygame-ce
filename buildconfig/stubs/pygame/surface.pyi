...
class PixelFormat:
    def __init__(self, format: int | str) -> None: ...
    def __str__(self) -> str: ...
    @classmethod
    def from_masks(cls, masks: tuple[int, int, int, int]) -> PixelFormat: ...
    @property
    def format(self) -> int: ...
    @property
    def name(self) -> str: ...
    ...
    @property
    def shifts(self) -> tuple[int, int, int, int]: ... # I don't know if this is useful, but you didn't say it wasn't
    @property
    def is_alpha(self) -> bool: ... # I feel like this is actually useful information for a pygamer!
    # leaving out: padding, bits, pixel_type, pixel_order, pixel_layout, is_fourcc, is_indexed, is_array, is_packed, is_float, is_10bit
